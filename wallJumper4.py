#My code for coin detections differs from spikes because I thought I was having an issue and I uesd ai to try to solve it. I could use the same method as the spikes, but it doesn't matter.
    ...
    while not game_over:
        ...
        for i in range(len(coin_list2)):
           if jumper_x >= 380 and coin_list2[i] == 300:
              print("coin")
              #coin_list2 = [y for y in coin_list2 if y < 300]
              #break
